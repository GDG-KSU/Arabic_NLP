...
for file_path in all_files:
    try:
        ...
        if not df.empty:
            ...
            print(f"✅ Successfully read: {os.path.basename(file_path)} | Rows: {len(df)}")
        else:
            print(f"⚠️ Warning: The file {os.path.basename(file_path)} is empty and was skipped.")
...
if data_frames_list:
    ...
    print("\n" + "="*40)
    print(f"🎉 Dataset merged successfully into a single file!")
